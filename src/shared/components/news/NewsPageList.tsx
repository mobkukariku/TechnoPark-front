...
export const NewsPageList: FC = () => {
  ...
  const { newsData, fetchNewsData, isLoading, page, totalPages, setPage } =
    useNewsStore();
  ...
  return (
    <Container className="relative z-20 mt-[20px] ">
      <div className="flex flex-row max-[1000px]:justify-center max-[1000px]:flex-wrap-reverse">
        <div
          className="w-[915px] flex flex-wrap max-[1000px]:mt-[50px] relative z-20 mb-[20px] max-[500px]:mb-[50px]
                                max-[500px]:w-full max-[500px]:flex max-[500px]:justify-center"
        >
          <div
            className="max-[500px]:h-fit flex max-[1000px]:justify-center flex-col max-[1000px]:items-center
                                    max-[500px]:w-full max-[500px]:items-center"
          >
            <p className="uppercase text-[32px] max-[500px]:text-[24px] mb-[30px] font-bold max-[500px]:text-center">
              {t("news")}
            </p>
