        ...
        <Container >
            <div className={"relative flex max-[1000px]:flex-col  items-center gap-[32px] justify-center "}>
                <div className={"w-[507px] max-[1000px]:w-fit relative z-20 flex flex-col gap-[10px]"}>
                    <p className={"text-[48px] max-[1000px]:text-center max-[500px]:text-[30px]  font-[800] leading-[58px] max-[500px]:leading-[35px]"}>СОЗДАВАЙТЕ БУДУЩЕЕ С НАМИ В <br/> <span className={"bg-[#2D7DFF] px-[15px] rounded-2xl text-white"}>SDU TECHNOPARK</span></p>
