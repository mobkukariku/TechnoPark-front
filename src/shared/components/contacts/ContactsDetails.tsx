...
export const ContactsDetails:FC = () => {
    return (
        <div className={"max-w-[1000px] relative z-50 flex flex-row m-auto mt-[50px] gap-16"}>
            <div className={"mt-[40px]"}>
                <ul className={"space-y-2 font-medium"}>
                    <li>
                        Адрес: Проспект Абылай хана 1/1, Каскелен
                    </li>
                    <li>
                ...
                <div className={"flex gap-[17px] mt-[30px] "}>
                    <Image src={"contacts/telegram.svg"} width={37} height={37} alt={"telega"}/>
                    <Image src={"contacts/linkedin.svg"} width={37} height={37} alt={"linkedin"}/>
                    <Image src={"contacts/insta.svg"} width={37} height={37} alt={"insta"}/>
                </div>
            </div>
            <iframe
