...
export const BurgerMenu: FC<BurgerMenuProps> = ({ onOpenModal }) => {
        ...
        <div className="absolute top-[90px] left-0 w-[90%] z-[110] bg-gray-100 p-4 rounded-[10px] border border-[#2D7DFF] dark:bg-gray-800">
          <div className="grid gap-4 pt-4">
            <Collapsible className="grid gap-4">
              <CollapsibleTrigger className="flex w-full items-center my-[10px] text-lg font-semibold [&[data-state=open]>svg]:rotate-90">
            ...
            {/* Use the Button component directly with onClick */}
